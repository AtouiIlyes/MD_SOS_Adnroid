...
public class FichesanteFragment extends Fragment  {
	...
	public FichesanteFragment(){}
	
	@Override
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
            Bundle savedInstanceState) {
 
        View rootView = inflater.inflate(R.layout.fragment_fiche_sante, container, false);
        
        Nom=(TextView) rootView.findViewById(R.id.textView1);
        NumAss=(TextView) rootView.findViewById(R.id.textView3);
        groupeSang=(TextView) rootView.findViewById(R.id.textView7);
        DonneurOrg=(TextView) rootView.findViewById(R.id.textView10);
        Assurence=(TextView) rootView.findViewById(R.id.textView12);
        Path1=(TextView) rootView.findViewById(R.id.textView16);
        Path2=(TextView) rootView.findViewById(R.id.textView17);
        Aller1=(TextView) rootView.findViewById(R.id.textView20);
        Aller2=(TextView) rootView.findViewById(R.id.textView21);
        Trait1=(TextView) rootView.findViewById(R.id.textView24);
        Trait2=(TextView) rootView.findViewById(R.id.textView25);
        Ant1=(TextView) rootView.findViewById(R.id.textView28);
        Ant2=(TextView) rootView.findViewById(R.id.textView29);
        Med=(TextView) rootView.findViewById(R.id.textView31);
        
        certif=(ImageView) rootView.findViewById(R.id.imageView1);
        
        b=(ImageButton) rootView.findViewById(R.id.btn1);
        b.setOnClickListener(new OnClickListener() {
			
			@Override
			public void onClick(View v) {
				Fragment fragment = new Edit_FicheDeSante();
	...
	public void affich(){
		...
		try{
			JSONArray data = new JSONArray(getJSONUrl("http://192.168.100.1/get_fichesante.php"));
